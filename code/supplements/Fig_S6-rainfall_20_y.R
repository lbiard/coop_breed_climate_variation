...
pp_check(model_20years, ndraws = 100) + xlim(c(0,1)) + theme_bw()
...
pp_check(model_15years, ndraws = 100) + xlim(c(0,1)) + theme_bw()
...
pp_check(model_10years, ndraws = 100) + xlim(c(0,1)) + theme_bw()
...
figure_s6 <- plot_posterior_coop_10y / plot_posterior_coop_15y / plot_posterior_coop_20y
