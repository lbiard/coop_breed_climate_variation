...
pp_check(meta_regression_cov, ndraws = 100) + xlim(c(0,2)) + theme_bw()
...
plot_mass <- ggplot(plot.dat, aes(x = inv_fun_mass(x2.sim), y = bayes.c.eff.mean)) +
  geom_ribbon(aes(ymin = bayes.c.eff.lower.bis4, ymax = bayes.c.eff.upper.bis4), fill = "tomato3", alpha = 0.15)+
  geom_ribbon(aes(ymin = bayes.c.eff.lower.bis3, ymax = bayes.c.eff.upper.bis3), fill = "tomato3", alpha = 0.15)+
  geom_ribbon(aes(ymin = bayes.c.eff.lower.bis2, ymax = bayes.c.eff.upper.bis2), fill = "tomato3", alpha = 0.15)+
  geom_ribbon(aes(ymin = bayes.c.eff.lower.bis, ymax = bayes.c.eff.upper.bis), fill = "tomato3", alpha = 0.15)+
  geom_ribbon(aes(ymin = bayes.c.eff.lower, ymax = bayes.c.eff.upper), fill = "tomato3", alpha = 0.15)+
  geom_line(color = "tomato3", linewidth = 1.8, alpha=0.7)+
  xlab("Log mass")+
...
plot_coop <- plot_coop + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis4[1], ymax = plot.dat$bayes.c.eff.upper.bis4[1], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis4[2], ymax = plot.dat$bayes.c.eff.upper.bis4[2], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis4[3], ymax = plot.dat$bayes.c.eff.upper.bis4[3], alpha=0.15, fill="tomato3")

plot_coop <- plot_coop + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis3[1], ymax = plot.dat$bayes.c.eff.upper.bis3[1], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis3[2], ymax = plot.dat$bayes.c.eff.upper.bis3[2], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis3[3], ymax = plot.dat$bayes.c.eff.upper.bis3[3], alpha=0.15, fill="tomato3")

plot_coop <- plot_coop + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis2[1], ymax = plot.dat$bayes.c.eff.upper.bis2[1], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis2[2], ymax = plot.dat$bayes.c.eff.upper.bis2[2], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis2[3], ymax = plot.dat$bayes.c.eff.upper.bis2[3], alpha=0.15, fill="tomato3")

plot_coop <- plot_coop + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis[1], ymax = plot.dat$bayes.c.eff.upper.bis[1], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis[2], ymax = plot.dat$bayes.c.eff.upper.bis[2], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis[3], ymax = plot.dat$bayes.c.eff.upper.bis[3], alpha=0.15, fill="tomato3")

plot_coop <- plot_coop + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower[1], ymax = plot.dat$bayes.c.eff.upper[1], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower[2], ymax = plot.dat$bayes.c.eff.upper[2], alpha=0.15, fill="tomato3")
plot_coop <- plot_coop + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower[3], ymax = plot.dat$bayes.c.eff.upper[3], alpha=0.15, fill="tomato3")

plot_coop <- plot_coop + annotate("segment", x = 0.7, xend = 1.3, y = plot.dat$bayes.c.eff.mean[1], yend = plot.dat$bayes.c.eff.mean[1], size=1.8, alpha=0.7, colour="tomato3")
plot_coop <- plot_coop + annotate("segment", x = 1.7, xend = 2.3, y = plot.dat$bayes.c.eff.mean[2], yend = plot.dat$bayes.c.eff.mean[2], size=1.8, alpha=0.7, colour="tomato3")
plot_coop <- plot_coop + annotate("segment", x = 2.7, xend = 3.3, y = plot.dat$bayes.c.eff.mean[3], yend = plot.dat$bayes.c.eff.mean[3], size=1.8, alpha=0.7, colour="tomato3")
...
plot_latitude_final <- plot_latitude + inset_element(plot_posterior_latitude, 0.5, 0.75, 0.95, 0.95)
plot_latitude_final
...
plot_mig <- plot_mig + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis4[1], ymax = plot.dat$bayes.c.eff.upper.bis4[1], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis4[2], ymax = plot.dat$bayes.c.eff.upper.bis4[2], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis4[3], ymax = plot.dat$bayes.c.eff.upper.bis4[3], alpha=0.15, fill="tomato3")

plot_mig <- plot_mig + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis3[1], ymax = plot.dat$bayes.c.eff.upper.bis3[1], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis3[2], ymax = plot.dat$bayes.c.eff.upper.bis3[2], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis3[3], ymax = plot.dat$bayes.c.eff.upper.bis3[3], alpha=0.15, fill="tomato3")

plot_mig <- plot_mig + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis2[1], ymax = plot.dat$bayes.c.eff.upper.bis2[1], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis2[2], ymax = plot.dat$bayes.c.eff.upper.bis2[2], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis2[3], ymax = plot.dat$bayes.c.eff.upper.bis2[3], alpha=0.15, fill="tomato3")

plot_mig <- plot_mig + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower.bis[1], ymax = plot.dat$bayes.c.eff.upper.bis[1], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower.bis[2], ymax = plot.dat$bayes.c.eff.upper.bis[2], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower.bis[3], ymax = plot.dat$bayes.c.eff.upper.bis[3], alpha=0.15, fill="tomato3")

plot_mig <- plot_mig + annotate("rect", xmin = 0.7, xmax = 1.3, ymin =  plot.dat$bayes.c.eff.lower[1], ymax = plot.dat$bayes.c.eff.upper[1], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 1.7, xmax = 2.3, ymin =  plot.dat$bayes.c.eff.lower[2], ymax = plot.dat$bayes.c.eff.upper[2], alpha=0.15, fill="tomato3")
plot_mig <- plot_mig + annotate("rect", xmin = 2.7, xmax = 3.3, ymin =  plot.dat$bayes.c.eff.lower[3], ymax = plot.dat$bayes.c.eff.upper[3], alpha=0.15, fill="tomato3")

plot_mig <- plot_mig + annotate("segment", x = 0.7, xend = 1.3, y = plot.dat$bayes.c.eff.mean[1], yend = plot.dat$bayes.c.eff.mean[1], size=1.8, alpha=0.7, colour="tomato3")
plot_mig <- plot_mig + annotate("segment", x = 1.7, xend = 2.3, y = plot.dat$bayes.c.eff.mean[2], yend = plot.dat$bayes.c.eff.mean[2], size=1.8, alpha=0.7, colour="tomato3")
plot_mig <- plot_mig + annotate("segment", x = 2.7, xend = 3.3, y = plot.dat$bayes.c.eff.mean[3], yend = plot.dat$bayes.c.eff.mean[3], size=1.8, alpha=0.7, colour="tomato3")
